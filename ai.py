            ...
            if piece:
                ...
                if piece.color() == 'red':
                    ...
                    if piece.is_king():
                        ...
                        w_safe += d
    if turn == 'red':
        red_count_heuristics = 3.354 * (((r_pawn + r_king * 2.0) - (w_pawn + 1.0 + w_king * 2.0)) / 1.0 + ((r_pawn + r_king * 2.0) + (w_pawn + w_king * 2.0)))
        ...
        white_count_heuristics = 3.354 * (((w_pawn + w_king * 2.0) - (r_pawn + 1.0 + r_king * 2.0)) /  1.0 + (((r_pawn + r_king * 2.0) + (w_pawn + w_king * 2.0))))
